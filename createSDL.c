...
SDL* createSDL(Atlas* atlas) {
  ...
  SDL_FillRect(getStamina(atlas), NULL, SDL_MapRGB(getScreen(sdl)->format, 1, 215, 88));
  SDL_FillRect(getLifePoint(atlas), NULL, SDL_MapRGB(getScreen(sdl)->format, 200, 7, 7));
