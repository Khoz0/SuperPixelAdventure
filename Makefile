SRC=zeldo.c game.c mapBuilder.c mapBoolean.c menu.c isEmpty.c keyboardEvent.c tileset.c picture.c destroyTab.c atlas.c display.c button.c buttonCollision.c booleans.c createSDL.c variables.c tables.c createText.c createAudio.c menuMove.c
BIN=jeu
