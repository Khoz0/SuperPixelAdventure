  ...
  switch(event.type){
      ...
      switch(event.key.keysym.sym){
			  ...
			  case SDLK_e:
				...
				case SDLK_z:
				  pressZ(game, xchar, ychar, sprint, dir, width);
				  break;

				case SDLK_s:
				  pressS(game, xchar, ychar, sprint, dir, width);
				  break;

				case SDLK_d:
				  pressD(game, xchar, ychar, sprint, dir, width);
				  break;

				case SDLK_q:
				  pressQ(game, xchar, ychar, sprint, dir, width);
				  break;
